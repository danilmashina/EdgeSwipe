...
> ⚠️ **Важно:** EdgeSwipe пока распространяется без Developer ID-подписи, поэтому шаг «Открыть всё равно» нужен только при первой установке. Никогда не обходите системное предупреждение для файлов из неизвестных источников — используйте только страницу Releases этого репозитория.
